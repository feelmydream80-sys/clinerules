...
| 단계 | 규칙 | 실행 내용 |
|------|------|----------|
| 1 | 00-core.md | 현재 프로젝트: `project_wordcloud` 확인 |
| 2 | 작업 유형 분류 | "공통 UI/디자인" → 04.design-change.md |
| 3 | 04.design-change.md | docs/ui/common/screen-domain.md 참조 |
| 4 | project_wordcloud | templates/screen-domain.md에서 파일 경로 확인 |
| 5 | 분석 | `web/templates/metadata_batch.html` 분석 |
| 6 | 계획 수립 | 사용자에게 예상 화면 제시 |
| 7 | 승인 후 구현 | 사용자 승인 후 코드 수정 |

### 결과
✅ project_wordcloud 폴더의 문서를 통해 정확한 파일 경로 확인 가능
...
| 3 | project_wordcloud | routes/api-routes.md 확인 |
| 4 | 분석 | 엔드포인트 경로, 함수 로직 분석 |
| 5 | 원인 파악 | 프론트엔드 vs 백엔드 불일치 확인 |

### 결과
✅ project_wordcloud/routes/ 문서로 정확한 엔드포인트 확인
...
| 3 | project_wordcloud | routes/metadata-routes.md 또는 services/metadata-service.md 제시 |
| 4 | 분석 | 해당 파일 확인 후 문제 파악 |

### 결과
✅ project_wordcloud 폴더로 정확한 안내 가능
...
| 3 | project_wordcloud | services/batch-service.md 확인 |
| 4 | 분석 | 현재 구조, 함수 의존성 파악 |
| 5 | 계획 | 사용자에게 수정 계획 제시 |

### 결과
✅ project_wordcloud/services/ 문서로 구조 파악 가능
