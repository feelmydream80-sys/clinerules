...
(
    ...
    cnn_failr_wrd_colr character varying(7) COLLATE pg_catalog."default" DEFAULT '#FF0000'::character varying,
    cnn_warn_icon_id integer,
    cnn_warn_wrd_colr character varying(7) COLLATE pg_catalog."default" DEFAULT '#FFA500'::character varying,
    cnn_sucs_icon_id integer,
    cnn_sucs_wrd_colr character varying(7) COLLATE pg_catalog."default" DEFAULT '#008000'::character varying,
    ...
    sucs_rt_sucs_wrd_colr character varying(7) COLLATE pg_catalog."default" DEFAULT '#008000'::character varying,
    sucs_rt_warn_icon_id integer,
    sucs_rt_warn_wrd_colr character varying(7) COLLATE pg_catalog."default" DEFAULT '#FFA500'::character varying,
